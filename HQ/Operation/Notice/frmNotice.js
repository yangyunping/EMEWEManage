...
jQuery(document).ready(function ($) {
    ...
    //新建角色按钮
    $("#btnAddNotice").live("click", function () {
        $('#DivAddNotice').modal()
    });
    ...
    $("#btnSaveAddRole").live("click", function () {
        ...
        //必填项检查
        if ($.checkEmpty("NoticeType", NoticeType, "该项为必填项!")) { return false; };
        if ($.checkEmpty("NoticeAction", NoticeAction, "该项为必填项!")) { return false; };
        if ($.checkEmpty("NoticeContext", NoticeContext, "该项为必填项!")) { return false; };



        var obj = {
            Url: "../../../BLL/HQ/Operation/Notice/frmNotice.ashx",
            Action: "add",
            FormId: "FormAddRole"
        };
    ...
    function RefreshTable() {
        var obj = {
            ...
            Url: "../../../BLL/HQ/Operation/Notice/frmNotice.ashx",//数据源URL
    ...
    $('#table').bootstrapTable({
        ...
        url: "../../../BLL/HQ/Operation/Notice/frmNotice.ashx?Action=Query",
