<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmNotice.aspx.cs" Inherits="CusStoreWeb.HQ.Operation.Notice.frmNotice" %>
...
<body class="page-header-fixed page-quick-sidebar-over-content ">
            ...
            <div class="page-content">
                ...
                <form id="btnMenu">
                    <div class="col-md-12">
                        ...
                        <button id="btnAddNotice" type="button" class="btn btn-sm blue">新建公告<i class="fa"></i></button>
                    </div>
                </form>
                <%--新建内容--%>
                <div class="modal fade" id="DivAddNotice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                                ...
                                <form id="FormAddRole">
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon right">
                                            ...
                                            <select class="form-control" name="NoticeType" id="NoticeType" style="text-align: left" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon right">
                                            ...
                                            <select class="form-control" name="NoticeAction" id="NoticeAction" style="text-align: left" tabindex="-1" aria-hidden="true">
                                                <option value="">请选择</option>
    ...
    <script src="frmNotice.js?_dc=<%=Guid.NewGuid() %>"></script>
</body>
<!-- END BODY -->
</html>
