...
jQuery(document).ready(function ($) {
    ...
    //新建角色按钮
    $("#btnAddHQRole").live("click", function () {
        $('#DivAddHQRole').modal()
    });
    ...
    $("#btnSaveAddRole").live("click", function () {
        ...
        var obj = {
            Url: "../../../BLL/HQ/Base/Role/frmRole.ashx",
            Action: "addRole",
            FormId: "FormAddRole"
        };
    ...
    function RefreshTable() {
        var obj = {
            ...
            Url: "../../../BLL/HQ/Base/Role/frmRole.ashx",//数据源URL
    ...
    $('#table').bootstrapTable({
        ...
        url: "../../../BLL/HQ/Base/Role/frmRole.ashx?Action=Query",
           ...
           },
        {
            ...
            formatter: function (value, row, index) {
                ...
                Auth = '<a href="#"  id="BtnItemAuth"  SID="' + row.ID + '"  RoleName="' + row.RoleName + '"      class="btn btn-success">功能授权</a>';
