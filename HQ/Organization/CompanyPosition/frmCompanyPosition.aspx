<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCompanyPosition.aspx.cs" Inherits="CusStoreWeb.HQ.Organization.CompanyPosition.frmCompanyPosition" %>
                            ...
                            <div class="modal-body">
                                <form id="FormAddHQRole">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="addHQRoleName" id="addHQRoleName"></input>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="HideBranchCode" id="HideBranchCode" style="display: none;"></input>
                                            ...
                                            <div class="tabbable-line boxless tabbable-reversed">
                                                <ul class="nav nav-tabs">
                                                    <li class="active">
                                                        <a href="#tab_YP" data-toggle="tab"><strong style="font-size: 16px;">公司端功能列表</strong></a>
                                                    </li>
                                                </ul>
