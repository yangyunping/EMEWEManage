...
<ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" id="ul_menu" runat="server">
        ...
        <ul class="sub-menu" style="display: block;"> <li><a href="javascript:;"><i class="icon-control-pause"></i>软件管理</a>  </li> <li><a href="javascript:;"><i class="icon-note"></i>硬件管理</a></li></ul>
        </li>
