...
<ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" id="ul_menu" runat="server">
        ...
        <li class="start active open" style="margin-top: 10px;"><a href='javascript:;'><i class="icon-home"></i><span class="title">软件开发组</span><span class='arrow '></span><span class="selected"></span></a>
