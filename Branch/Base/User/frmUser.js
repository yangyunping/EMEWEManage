...
jQuery(document).ready(function ($) {
    ...
    function LoadRoleList() {
        ...
        var obj = {
            ...
            Url: "../../../BLL/Branch/Base/User/frmUser.ashx",
            Action: "LoadRoleList"//,
    ...
    //保存账号
    $("#btnSaveAddUser").live("click", function () {
        ...
        if ($.checkZiMu_Number_ZiFu("addUserPwd", addUserPwd, "输入的密码不正确,密码规则如下：包含数字,大写字母,小写字母,特殊字符四选三,且长度在8到30个数之间!")) { return false; };
    ...
    function RefreshTable() {
        var obj = {
            ...
            Url: "../../../BLL/Branch/Base/User/frmUser.ashx",//数据源URL
    ...
    $('#table').bootstrapTable({
        ...
        url: "../../../BLL/Branch/Base/User/frmUser.ashx?Action=Query",
