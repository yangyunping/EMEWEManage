<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmUser.aspx.cs" Inherits="CusStoreWeb.Branch.Base.User.frmUser" %>
...
<body class="page-header-fixed page-quick-sidebar-over-content ">
            ...
            <div class="page-content">
                ...
                <form id="searchform">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <label for="inputPassword" class="col-sm-1 control-label" style="text-align: right">姓名或账号</label>
                        <div class="col-sm-11">

                            <div class="input-icon right">

                                <input type="text" class="form-control" style="text-align: left" id="searchKey" name="searchKey"
                                    placeholder="模糊搜索">
                            </div>
                        </div>
                ...
                <form id="btnMenu">
                    <div class="col-md-12">
                        ...
                        <button id="btnAddUser" type="button" class="btn btn-sm red">新建账号<i class="fa"></i></button>
                    </div>
                </form>
                <%--新建账号--%>
                <div class="modal fade" id="DivAddUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="FormAddUser">
                                    ...
                                    <div class="form-group">
                                        <label for="message-text" class="control-label">账号:【账号必须大于等于五位且只能输入字母或数字或字母数字组合】</label>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" id="btnSaveAddUser">保存</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="frmUser.js?_dc=<%=Guid.NewGuid() %>"></script>
</body>
<!-- END BODY -->
</html>
