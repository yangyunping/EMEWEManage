<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmRole.aspx.cs" Inherits="CusStoreWeb.Branch.Base.Role.frmRole" %>
            ...
            <div class="page-content">
                ...
                <form id="btnMenu">
                    <div class="col-md-12">
                        ...
                        <button id="btnAddBranchRole" type="button" class="btn btn-sm blue">新建角色<i class="fa"></i></button>
                    </div>
                </form>
                <%--新建角色--%>
                <div class="modal fade" id="DivAddBranchRole" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
