<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCompanyPosition.aspx.cs" Inherits="CusStoreWeb.Branch.Store.CompanyPosition.frmCompanyPosition" %>
...
<body class="page-header-fixed page-quick-sidebar-over-content">
            ...
            <div class="page-content">
                ...
                <form id="searchform">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="inputPassword" class="col-sm-1 control-label" style="text-align: right">职位名称</label>
                        <div class="col-sm-11">
                ...
                <form id="btnMenu">
                    <div class="col-md-12">
                        ...
                        <button id="btnAddStoreRole" type="button" class="btn btn-sm blue">新建门店端职位<i class="fa"></i></button>
                    </div>
                </form>
                <%--新建公司端角色--%>
                <div class="modal fade" id="DivAddStoreRole" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title" id="exampleModalLabel">新建门店端职位</h4>
                            </div>
                            <div class="modal-body">
                                <form id="FormAddStoreRole">
                                    <div class="form-group">
                                        <label for="inputPassword" style="text-align: right">门店名称</label>


                                        <div class="input-icon right">

                                            <select class="form-control " id="SiteCodeList" name="SiteCodeList" style="text-align: left" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <form id="FormEditRole">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="HideSiteCode" id="HideSiteCode" style="display: none;"></input>
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="HideAuthPID" id="HideAuthPID" style="display: none;"></input> 
                                                 <input class="form-control" name="HideAuthSiteCode" id="HideAuthSiteCode" style="display: none;"></input>
                                                <input class="form-control" id="AuthBranchName" disabled></input>
                                            </div>

                                             <div class="form-group">
                                                <label for="message-text" class="control-label">门店名称:</label>
                                                <input class="form-control" id="AuthSiteName" disabled></input>
                                            </div>
                                            <div class="form-group">
                                                <label for="message-text" class="control-label">职位名称:</label>
                                            ...
                                            <div class="tabbable-line boxless tabbable-reversed">
                                                <ul class="nav nav-tabs">
                                                    <li class="active">
                                                        <a href="#tab_YP" data-toggle="tab"><strong style="font-size: 16px;">门店端功能列表</strong></a>
                                                    </li>
                                                </ul>
    ...
    <script src="frmCompanyPosition.js?_dc=<%=Guid.NewGuid() %>"></script>
</body>
<!-- END BODY -->
</html>
