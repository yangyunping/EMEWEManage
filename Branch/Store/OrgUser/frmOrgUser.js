...
jQuery(document).ready(function ($) {
    ...
    $("#btnAddSite").live("click", function () {
        $('#DivAddOrgUser').modal();
        LoadSiteList();//默认加载门店列表
    });

    //根据门店查询职位
    $("#LoadSiteList").on('change', function (event) {
        var SiteCode = $("#LoadSiteList option:selected").val();
      
        var obj = {

            Url: "../../../BLL/Branch/Store/OrgUser/frmOrgUser.ashx",
            Action: "SiteCodeChange",
        ...
        $.FillSelectOption("LoadRoleList", jsonText);
    });




    function LoadSiteList()//默认加载门店列表
    {
        ...
        $.SubmitPostData(obj);
        var jsonText = obj.jsonText;
        $.FillSelectOption("LoadSiteList", jsonText); 

    }


    $("#btnSaveAddOrgUser").live("click", function () {
        var LoadSiteList = $("#LoadSiteList").val();
        var LoadRoleList = $("#LoadRoleList").val();
        ...
        if ($.checkEmpty("LoadSiteList", LoadSiteList, "该项为必填项!")) { return false; };
        if ($.checkEmpty("LoadRoleList", LoadRoleList, "该项为必填项!")) { return false; };
    ...
    function RefreshTable() {
        var obj = {
            ...
            Url: "../../../BLL/Branch/Store/OrgUser/frmOrgUser.ashx",//数据源URL
    ...
    $('#table').bootstrapTable({
        ...
        url: "../../../BLL/Branch/Store/OrgUser/frmOrgUser.ashx?Action=Query",
