<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmOrgUser.aspx.cs" Inherits="CusStoreWeb.Branch.Store.OrgUser.frmOrgUser" %>
            ...
            <div class="page-content">
                ...
                <form id="searchform">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <label for="inputPassword" class="col-sm-1 control-label" style="text-align: right">员工姓名</label>
                        <div class="col-sm-11">

                            <div class="input-icon right">

                                <input type="text" class="form-control" style="text-align: left" id="searchUserName" name="searchUserName"
                                    placeholder="模糊搜索">
                            </div>
                        </div>
                ...
                <form id="btnMenu">
                    <div class="col-md-12">
                        ...
                        <button id="btnAddSite" type="button" class="btn btn-sm red">新建门店用户<i class="fa"></i></button>
                    </div>
                </form>
                <%--新建门店用户--%>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="exampleModalLabel">新建门店用户</h4>
                            </div>
                            <div class="modal-body">
                                <form id="FormAddOrgUser">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">门店名称:</label>
                                        <div class="input-icon right">

                                            <select class="form-control " name="SiteCode" id="LoadSiteList" style="text-align: left" tabindex="-1" aria-hidden="true">
                                            </select> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon right">
                                            ...
                                            <select class="form-control " name="RoleID" id="LoadRoleList" style="text-align: left" tabindex="-1" aria-hidden="true">
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <label for="message-text" class="control-label">员工姓名:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="message-text" class="control-label">账号:【( <a class="forget Cred" href="javascript:;">系统自动加上门店代码</a>)账号必须大于等于五位且只能输入字母或数字或字母数字组合】</label>
