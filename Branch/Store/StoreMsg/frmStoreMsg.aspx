<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmStoreMsg.aspx.cs" Inherits="CusStoreWeb.Branch.Store.StoreMsg.frmStoreMsg" %>
...
<body class="page-header-fixed page-quick-sidebar-over-content ">
    ...
    <script src="frmStoreMsg.js?_dc=<%=Guid.NewGuid() %>"></script>
</body>
<!-- END BODY -->
</html>
